...
/** Read a query param from URLSearchParams/ReadonlyURLSearchParams or a plain object */
...
export default async function HomePage({
  ...
  return (
    <main className="min-h-dvh">
      ...
      {/* Client-only enhancements (wired through the no-SSR wrapper).
         Casting as any here prevents tight coupling to HomeClient’s exact prop
         shape while keeping the page type-safe for Next 15. */}
      <HomeClientNoSSR
        {...({
          items,
          mode: t,
