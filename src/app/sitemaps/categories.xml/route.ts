...
// IMPORTANT:
// Only enable category URLs if you actually have a real /category/* route to serve them.
// Otherwise, submitting these URLs will create 404/soft-404 indexing issues.
function categoryUrlsEnabled(): boolean {
  return process.env["SITEMAP_ENABLE_CATEGORY_URLS"] === "1";
}

export async function GET() {
  if (!hasValidDbUrl() || shouldSkipDb() || !categoryUrlsEnabled()) {
