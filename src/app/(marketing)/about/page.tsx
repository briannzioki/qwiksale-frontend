...
function Feature({
  ...
  return (
    <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-elevated)] p-5 text-[var(--text)] shadow-soft">
      <div className="flex items-start gap-3">
        {icon ? (
          <div className="text-brandBlue-600" aria-hidden>
            {icon}
          </div>
        ) : null}
        <div>
...
function Stat({
  ...
  return (
    <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-elevated)] p-5 text-center text-[var(--text)] shadow-soft">
...
function TimelineItem({
  ...
  return (
    <li className="relative pl-6">
      <span
        className="absolute left-0 top-1.5 h-3 w-3 rounded-full bg-brandBlue-600"
        aria-hidden
      />
...
function TeamCard({
  ...
  return (
    <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-elevated)] p-4 text-[var(--text)] shadow-soft">
...
function FAQItem({ q, a }: { q: string; a: React.ReactNode }) {
  return (
    <details className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-elevated)] p-4 text-[var(--text)] shadow-soft">
      <summary className="cursor-pointer list-none font-medium text-[var(--text)]">
        {q}
      </summary>
      <div className="mt-2 text-sm text-[var(--text-muted)]">{a}</div>
    </details>
  );
}
  ...
  return (
    <main className="min-h-dvh text-[var(--text)]">
      ...
      <div className="container-page py-8 md:py-10">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {values.map((v) => (
              <Chip
                key={v}
                dense
                className="bg-subtle border-[var(--border-subtle)] text-[var(--text)]"
              >
                {v}
              </Chip>
            ))}
        ...
        {/* Team */}
        <section className="mt-8">
          <h2 className="text-lg font-semibold text-[var(--text)]">Team</h2>
        ...
        {/* FAQ */}
        <section className="mt-8">
          <h2 className="text-lg font-semibold text-[var(--text)]">FAQs</h2>
            ...
            <FAQItem
              ...
              a={
                <>
                  ...
                  or email{" "}
                  <a
                    href="mailto:support@qwiksale.app"
                    className="underline"
                  >
        ...
        {/* CTA */}
        <section className="mt-10 flex flex-col items-center rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-elevated)] p-6 text-center text-[var(--text)] shadow-soft">
