    ...
    <div className="container-page py-10">
      ...
      <div className="mt-8 prose max-w-3xl dark:prose-invert">
        <p className="text-sm">
          ...
          <strong>https://qwiksale.sale</strong> and related services (the
        ...
        <ul>
          <li>
            <strong>Account &amp; profile:</strong> name, email, username,
            password (hashed), avatar, optional WhatsApp/phone, location, bio,
            social links.
          </li>
          <li>
            <strong>Listings &amp; content:</strong> titles, descriptions,
            photos, category, price, location.
          </li>
          <li>
          ...
          <li>
            <strong>Payments:</strong> donation/upgrade signals and receipts
            (e.g., M-Pesa request IDs and status).{" "}
            <em>We never collect or store your M-Pesa PIN.</em>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Usage &amp; diagnostics:</strong> device/browser type, pages
            viewed, actions, timestamps, IP address, approximate location, crash
            logs.
          </li>
          <li>
            <strong>Cookies/SDKs:</strong> session cookies to keep you signed
            in, analytics to improve performance, and security cookies to
            prevent abuse.
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Public content:</strong> listings, store pages, usernames,
            some profile details are public by design.
          </li>
          <li>
            <strong>Processors:</strong> hosting, databases, storage/CDN, image
            processing, analytics, logging/monitoring, and payment gateways
            (e.g., Safaricom Daraja for M-Pesa). Processors act under contracts
            and only process data on our instructions.
          </li>
          <li>
            <strong>Legal/safety:</strong> we may disclose information to comply
            with laws, lawful requests, or to protect rights and safety.
          </li>
          <li>
            <strong>Business transfers:</strong> in a merger/acquisition, data
            may transfer under this Policy.
          </li>
        </ul>
        ...
        <p>
          ...
          above, to provide the Services, comply with legal obligations, resolve
          disputes, and enforce agreements.
        </p>
        <ul>
          <li>Account basics: kept while your account is active.</li>
          <li>
            Listings &amp; public content: kept until you remove them or your
            account is deleted.
          </li>
          <li>
        ...
        <p>
          We may process data outside your country. Where required, we implement
          safeguards such as Standard Contractual Clauses (SCCs) or equivalent,
          and ensure processors provide adequate protection. Kenya users are
          protected under the Data Protection Act, 2019 and Regulations.
        </p>
        ...
        <ul>
          ...
          <li>
            Withdraw consent at any time (e.g., marketing), without affecting
            prior lawful use.
          </li>
        </ul>
        <p>
        ...
        <ul>
          <li>
            Rights include access, correction, objection to processing, and
            deletion.
          </li>
          <li>
            You may contact the Office of the Data Protection Commissioner
            (ODPC) for guidance or complaints.
          </li>
        </ul>
        ...
        <ul>
          <li>
            Rights to know, delete, correct, and to opt out of “selling” or
            “sharing” personal information (as defined by CPRA).
          </li>
          <li>
        ...
        <ul>
          <li>
            <strong>Strictly necessary:</strong> auth/session, security, basic
            functionality.
          </li>
          <li>
            <strong>Performance/analytics:</strong> usage and performance
            metrics (aggregated).
          </li>
          <li>
          ...
          <li>
            <strong>Marketing (if enabled):</strong> only with consent where
            required.
          </li>
        </ul>
        <p>
          You can manage cookies in your browser. Blocking some cookies may
          impact functionality. If we use consent banners, your preferences are
          honored and can be changed any time.
        </p>

        <h2 id="marketing">9) Marketing communications</h2>
        <p>
          You can unsubscribe from marketing emails using the link in the email
          footer or by contacting us. Service/transactional emails (e.g.,
          receipts, security notices) will still be sent.
        </p>

        <h2 id="automated">10) Automated decision-making</h2>
        <p>
          We do not make decisions producing legal or similarly significant
          effects solely via automated processing. We may use automated signals
          (e.g., spam/fraud detection) to protect the platform; manual review is
          available.
        </p>
        ...
        <p>
          Content you submit (e.g., listings, photos) may be public by design.
          Think carefully before posting personal information in public fields.
        </p>

        <h2 id="children">13) Children</h2>
        <p>
          The Services are not directed to children under the age required by
          local law to consent to data processing. If we learn we’ve collected
        ...
        <ul>
          ...
          <li>
            ...
            portable format where required by law.
          </li>
        </ul>

        <h2 id="third-parties">15) Third-party links</h2>
        <p>
          Our Services may link to third-party sites. Their privacy practices
          are governed by their own policies. Review them before providing
          personal information.
        </p>

        <h2 id="dntr">16) “Do Not Track”</h2>
        <p>
          We currently do not respond to browser “Do Not Track” signals. You can
          control cookies in your browser and opt out of marketing where
          offered.
        </p>
        ...
        <p>
          ...
          version with a new “Last updated” date and, where appropriate, provide
          additional notice.
        </p>
        ...
        <ul>
          ...
          <li>
            If you believe we have not resolved your concern, you may appeal to
            us at the same address (subject “Privacy Appeal”) or contact your
            data protection authority (e.g., ODPC in Kenya, your EU/UK
            Supervisory Authority, or your state AG in the U.S.).
          </li>
        </ul>

        <hr />
        <p className="text-xs opacity-75">
          This summary is provided for transparency and ease of understanding.
          It does not replace applicable law or any rights granted to you
          thereunder.
        </p>
      </div>
    </div>
