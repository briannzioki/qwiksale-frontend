...
export const metadata: Metadata = {
  ...
  description: "Your QwikSale account has been deleted. Weâ€™re sorry to see you go.",
    ...
    <main className="mx-auto flex min-h-[70vh] max-w-2xl items-center justify-center p-6">
      <div className="w-full overflow-hidden rounded-3xl border border-gray-200/80 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="space-y-5 p-6 md:p-8">
          <p className="text-lg font-semibold text-gray-900 dark:text-slate-100">Your account has been deleted.</p>

          <p className="text-sm leading-relaxed text-gray-600 dark:text-slate-300">
            If this was a mistakeâ€”or you change your mindâ€”youâ€™re welcome back anytime. Your personal data has been scheduled
            for removal according to our{" "}
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <Link href={`/signin?callbackUrl=${encodeURIComponent("/dashboard")}`} className="btn-outline text-center">
