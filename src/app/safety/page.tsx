    ...
    <div className="container-page py-8">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <div className="hero-surface">
          <h1 className="text-2xl md:text-3xl font-extrabold">Safety Guidelines</h1>
          <p className="text-sm text-white/80">
            QwikSale is a peer-to-peer marketplace. These best practices help keep you safe when
            buying or selling.
          </p>
          <p className="text-xs text-white/60 mt-1">Last updated {lastUpdated}</p>
        </div>
